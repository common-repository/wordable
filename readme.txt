...
[Get started today](https://wordable.io/pricing) and start saving at least ~30-minutes every time you need to export a Google Doc to WordPress, uploading, formatting, optimizing, and publishing each post.
...
- [How to Instantly Upload Google Docs to WordPress](https://wordable.io/google-docs-to-wordpress/)
- [Still copying content into WordPress? You’re doing it wrong. Here’s why.](https://wordable.io/copying-content-into-wordpress-wrong/)
- [Pro Content Optimization Tips from Publishing 300+ / Month](https://wordable.io/content-optimization/)
...
= 8.2.8 =
* Updated WordPress directory description
